...
> **Alias:** This skill can also be invoked as `/ioc-deep-dive`
...
```
IF "deep-dive-ioc" NOT IN active_agent.permissions.primary_skills
   AND "deep-dive-ioc" NOT IN active_agent.permissions.allowed_skills:
    BLOCK with message:
    ╔════════════════════════════════════════════════════════════════╗
    ║  SKILL BLOCKED: Permission denied                              ║
    ╠════════════════════════════════════════════════════════════════╣
    ║  The /deep-dive-ioc skill is forbidden for <active_agent.name>. ║
    ║                                                                ║
