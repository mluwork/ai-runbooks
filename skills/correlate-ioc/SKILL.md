...
> **Alias:** This skill can also be invoked as `/ioc-correlate`
...
```
IF "correlate-ioc" NOT IN active_agent.permissions.primary_skills
   AND "correlate-ioc" NOT IN active_agent.permissions.allowed_skills:
    BLOCK with message:
    ╔════════════════════════════════════════════════════════════════╗
    ║  SKILL BLOCKED: Permission denied                              ║
    ╠════════════════════════════════════════════════════════════════╣
    ║  The /correlate-ioc skill is forbidden for <active_agent.name>. ║
    ║                                                                ║
