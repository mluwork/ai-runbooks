...
```
IF "respond-compromised-account" NOT IN active_agent.permissions.primary_skills
   AND "respond-compromised-account" NOT IN active_agent.permissions.allowed_skills:
    BLOCK with message:
    ╔════════════════════════════════════════════════════════════════╗
    ║  SKILL BLOCKED: Permission denied                              ║
    ╠════════════════════════════════════════════════════════════════╣
    ║  The /respond-compromised-account skill is forbidden for       ║
    ║  <active_agent.name>.                                          ║
    ║                                                                ║
