...
> **Alias:** This skill can also be invoked as `/ioc-pivot`
...
```
IF "pivot-on-ioc" NOT IN active_agent.permissions.primary_skills
   AND "pivot-on-ioc" NOT IN active_agent.permissions.allowed_skills:
    BLOCK with message:
    ╔════════════════════════════════════════════════════════════════╗
    ║  SKILL BLOCKED: Permission denied                              
╠════════════════════════════════════════════════════════════════╣
    ║  The /pivot-on-ioc skill is forbidden for <active_agent.name>. 
║                                                                
