...
> **Alias:** This skill can also be invoked as `/ioc-hunt`
...
```
IF "hunt-ioc" NOT IN active_agent.permissions.primary_skills
   AND "hunt-ioc" NOT IN active_agent.permissions.allowed_skills:
    BLOCK with message:
    ╔════════════════════════════════════════════════════════════════╗
    ║  SKILL BLOCKED: Permission denied                              ║
    ╠════════════════════════════════════════════════════════════════╣
    ║  The /hunt-ioc skill is forbidden for <active_agent.name>.     ║
    ║                                                                ║
